...
exports.generate = async (req, res) => {
    ...
    // recupère en parametre get id annonceur / id campagne / date de debut let
    // advertiserid = req.params.advertiserid; let campaignid =
    // req.params.campaignid; let startDate = req.params.startdate; let endDate =
    // req.params.enddate;
...
exports.report = async (req, res) => {
    ...
    var campaign = await ModelCampaigns
        ...
        .then(async function (campaign) {
            ...
            // Initialise la date
            let date = new Date();
            let cacheStorageIDHour = 'campagneId-' + campaignid+'_'+date.getFullYear()+'-'+date.getMonth()+'-'+date.getDate()+'_'+date.getHours();
            ...
            try {
                ...
                if (data_localStorage) {
                    ...
                    function getEndDate_last(unixTimeStamp) {
                        ...
                        return (date_last.getFullYear() + '-' + (
                            '0' + (
                                date_last.getMonth() + 1
                            )
                        ).slice(-2) + '-' + (
                            '0' + date_last.getDate()
                        ).slice(-2) + 'T' + (
                            '0' + date_last.getHours()
                        ).slice(-2) + ':' + (
                            '0' + date_last.getMinutes()
                        ).slice(-2) + ':00')
                    }
                    ...
                    let firstLinkTaskId = localStorage_tasks.getItem('campagneId-' + campaignid + '-firstLink-'+cacheStorageIDHour);
                    ...
                    let twoLinkTaskId = localStorage_tasks.getItem('campagneId-' + campaignid + '-twoLink-'+cacheStorageIDHour);
                    if(!twoLinkTaskId) {
                    ...
                    console.log('Line 358',firstLinkTaskId); console.log('Line 358',twoLinkTaskId); 
                    ...
                    if (firstLinkTaskId || twoLinkTaskId) {
                        ...
                        console.log('Line 368',requete_global); 
                        console.log('Line 369',requete_vu); 
                        ...
                        let timerFile = setInterval(async () => {
                           ...
                           //  time += 10000;
                            ...
                            console.log('Line 382',dataLSTaskGlobal); 
                            console.log('Line 383',dataLSTaskGlobalVU); 
                              ...
                              // let fourLink = await AxiosFunction.getReportingData('GET', requete_vu, '');
                                ...
                                if(!dataLSTaskGlobal) {
                                    ...
                                    if ((threeLink.data.lastTaskInstance.jobProgress == '1.0') && (threeLink.data.lastTaskInstance.instanceStatus == 'SUCCESS')) {
                                        ...
                                        let dataLSTaskGlobal = localStorage_tasks.getItem('campagneId-' + campaignid + '-task_global');
                                        if(!dataLSTaskGlobal) {
                                            ...
                                            dataLSTaskGlobal = { 'datafile': dataFile.data };
                                            localStorage_tasks.setItem('campagneId-' + campaignid + '-task_global', JSON.stringify(dataLSTaskGlobal) );
                                        }
                                    }
                                 }
                               ...
                               if(!dataLSTaskGlobalVU) {
                                    ...
                                    if ((fourLink.data.lastTaskInstance.jobProgress == '1.0') && (fourLink.data.lastTaskInstance.instanceStatus == 'SUCCESS')) {
                                        ...
                                        dataLSTaskGlobalVU = localStorage_tasks.getItem('campagneId-' + campaignid + '-task_global_vu');
                                        if(!dataLSTaskGlobalVU) {
                                            ...
                                            dataLSTaskGlobalVU = { 'datafile': dataFile2.data };
                                            localStorage_tasks.setItem( 'campagneId-' + campaignid + '-task_global_vu', JSON.stringify(dataLSTaskGlobalVU) );
                                        }
                                    }
                               }
                               ...
                               if(!dataLSTaskGlobal && dataLSTaskGlobalVU) {
                                ...
                                //traitement des resultats requête 1
              ...
              CTR = Taux_clics.toFixed(2);*/
                                ...
                                total_impressions_linfo_androidVideo = numStr(
                                ...
                                total_impressions_actu_androidVideo = numStr(
                                ...
                                total_impressions_linfo_androidHabillage = numStr(
                                    total_impressions_linfo_androidHabillage
                                );
                                total_clicks_linfo_androidHabillage = numStr(
                                    total_clicks_linfo_androidHabillage
                                );
                                total_impressions_linfo_iosHabillage = numStr(
                                ...
                                total_impressions_dailymotionMasthead = numStr(
                                ...
                                total_impressions_actu_androidMasthead = numStr(
                                ...
                                total_impressions_linfo_androidGrandAngle = numStr(
                                    total_impressions_linfo_androidGrandAngle
                                );
                                total_clicks_linfo_androidGrandAngle = numStr(
                                    total_clicks_linfo_androidGrandAngle
                                );
                                total_impressions_linfo_iosGrandAngle = numStr(
                                ...
                                total_impressions_antenneGrandAngle = numStr(
                                ...
                                total_impressions_linfo_androidNative = numStr(
                                ...
                                total_impressions_dailymotionNative = numStr(
                                ...
                                total_impressions_actu_androidNative = numStr(
