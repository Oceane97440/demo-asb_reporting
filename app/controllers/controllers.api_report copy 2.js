                        ...
                        let timerFile = setInterval(async () => {
                            ...
                            if (!dataLSTaskGlobal || !dataLSTaskGlobalVU) {
                                ...
                                if ((InsertionName.length > 1) && (Array.isArray(InsertionName) === true)) {
                                    ...
                                    var rectangle_videoImpressions = new Array();
                                    var rectangle_videoClicks = new Array();
                                    var rectangle_videoSitename = new Array();
                                    var rectangle_videoFormatName = new Array();
                                    var rectangle_videoCTR = new Array();
                                    ...
                                    async function rectangle_videoArrayElements(element, index, array) {
                                        ...
                                        switch (Array_SiteID[element]) {
                                                //sous traitement des array / filtre par format et par site
                                            case "322433":
                                                rectanglevideo_linfo_impression.push(eval(Array_Impressions[element]));
                                                rectanglevideo_linfo_click.push(eval(Array_Clicks[element]));
                                                rectanglevideo_linfo_siteId.push(Array_SiteID[element]);
                                                rectanglevideo_linfo_siteName.push(Array_SiteName[element]);
                                                break;
                                            case "299249":
                                                rectanglevideo_linfo_android_impression.push(eval(Array_Impressions[element]));
                                                rectanglevideo_linfo_android_click.push(eval(Array_Clicks[element]));
                                                rectanglevideo_linfo_android_siteId.push(Array_SiteID[element]);
                                                rectanglevideo_linfo_android_siteName.push(Array_SiteName[element]);
                                                break;
                                            case "299248":
                                                rectanglevideo_linfo_ios_impression.push(eval(Array_Impressions[element]));
                                                rectanglevideo_linfo_ios_click.push(eval(Array_Clicks[element]));
                                                rectanglevideo_linfo_ios_siteId.push(Array_SiteID[element]);
                                                rectanglevideo_linfo_ios_siteName.push(Array_SiteName[element]);
                                                break;
                                            case "323124":
                                                rectanglevideo_dtj_impression.push(eval(Array_Impressions[element]));
                                                rectanglevideo_dtj_click.push(eval(Array_Clicks[element]));
                                                rectanglevideo_dtj_siteId.push(Array_SiteID[element]);
                                                rectanglevideo_dtj_siteName.push(Array_SiteName[element]);
                                                break;
                                            case "299263":
                                                rectanglevideo_antenne_impression.push(eval(Array_Impressions[element]));
                                                rectanglevideo_antenne_click.push(eval(Array_Clicks[element]));
                                                rectanglevideo_antenne_siteId.push(Array_SiteID[element]);
                                                rectanglevideo_antenne_siteName.push(Array_SiteName[element]);
                                                break;
                                            case "299252":
                                                rectanglevideo_orange_impression.push(eval(Array_Impressions[element]));
                                                rectanglevideo_orange_click.push(eval(Array_Clicks[element]));
                                                rectanglevideo_orange_siteId.push(Array_SiteID[element]);
                                                rectanglevideo_orange_siteName.push(Array_SiteName[element]);
                                                break;
                                            case "299245":
                                                rectanglevideo_tf1_impression.push(eval(Array_Impressions[element]));
                                                rectanglevideo_tf1_click.push(eval(Array_Clicks[element]));
                                                rectanglevideo_tf1_siteId.push(Array_SiteID[element]);
                                                rectanglevideo_tf1_siteName.push(Array_SiteName[element]);

                                                break;
                                            case "299244":
                                                rectanglevideo_m6_impression.push(eval(Array_Impressions[element]));
                                                rectanglevideo_m6_click.push(eval(Array_Clicks[element]));
                                                rectanglevideo_m6_siteId.push(Array_SiteID[element]);
                                                rectanglevideo_m6_siteName.push(Array_SiteName[element]);
                                                break;
                                            case "337707":
                                                rectanglevideo_dailymotion_impression.push(eval(Array_Impressions[element]));
                                                rectanglevideo_dailymotion_click.push(eval(Array_Clicks[element]));
                                                rectanglevideo_dailymotion_siteId.push(Array_SiteID[element]);
                                                rectanglevideo_dailymotion_siteName.push(Array_SiteName[element]);
                                                break;
                                            case "299253":
                                                rectanglevideo_actu_ios_impression.push(eval(Array_Impressions[element]));
                                                rectanglevideo_actu_ios_click.push(eval(Array_Clicks[element]));
                                                rectanglevideo_actu_ios_siteId.push(Array_SiteID[element]);
                                                rectanglevideo_actu_ios_siteName.push(Array_SiteName[element]);
                                                break;
                                            case "299254":
                                                rectanglevideo_actu_android_impression.push(eval(Array_Impressions[element]));
                                                rectanglevideo_actu_android_click.push(eval(Array_Clicks[element]));
                                                rectanglevideo_actu_android_siteId.push(Array_SiteID[element]);
                                                rectanglevideo_actu_android_siteName.push(Array_SiteName[element]);
                                                break;
