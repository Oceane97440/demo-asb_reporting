    ...
    try {
        ...
        var campaign = await ModelCampaigns
            ...
            .then(async function (campaign) {
                ...
                let endDate = campaign.campaign_end_date;
                ...
                try {
                    ...
                    if (data_localStorage) {
                       ...
                       console.log('campaign_end_date :', campaign_end_date);
                        ...
                        const endDate_day = new Date(endDate);
...
exports.reportage = async (req, res) => {
    let campaigncrypt = req.params.campaigncrypt;
        ...
        .then(async function (campaign) {
            ...
            try {
                ...
                if (data_localStorage) {
                    ...
                    console.log('Date expiration :', date_expiry)
                    ...
                    if (firstLinkTaskId || twoLinkTaskId) {
                        ...
                        let timerFile = setInterval(async () => {
                            ...
                            if (!dataLSTaskGlobal || !dataLSTaskGlobalVU) {
                                ...
                                if(timerFile) { clearInterval(timerFile); }
                                console.log(
                                    'On arrête la fonction setInterval si il y a les 2 taskID en cache'
                                );
                                ...
                                // console.log(VTR_actu_android) var Taux_clics = (TotalCliks /
