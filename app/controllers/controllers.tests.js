...
exports.duplication = async (req, res) => {
    ...
    try {
        ...
        const body = {
            ...
            display_desktop_file: 'https://www.linfo.re/IMG/pub/display/LUCA/20211123/LA_GRANDE_RECRE-74162/SITE/300x600.jpg',
            display_desktop_url: 'https://lagranderecre.re/?utm_source=antenne&utm_medium=banner&utm_campaign=LGR_Noel&utm_id=LGR+Noel',

            display_mobile_file: 'https://www.linfo.re/IMG/pub/display/LUCA/20211123/LA_GRANDE_RECRE-74162/SITE/300x250.jpg',
            display_mobile_url: 'https://lagranderecre.re/?utm_source=antenne&utm_medium=banner&utm_campaign=LGR_Noel&utm_id=LGR+Noel',

            display_tablette_file: 'https://www.linfo.re/IMG/pub/display/LUCA/20211123/LA_GRANDE_RECRE-74162/SITE/300x250.jpg',
        ...
        await ModelInsertions.findAll({
            ...
            for (let i = 0; i < insertion_model.length; i++) {
                if (!Utilities.empty(insertion_model)) {
                    ...
                    if (!Utilities.empty(insertion_model)) {
                        console.log(insertion_id_model, ' - ', insertion_name_model)
                        ...
                        requestInsertionsCopy = {
                            ...
                            "insertionStatusId": 0,
                            "startDate": "2022-11-01T03:00:00",
                            "endDate": "2023-01-01T02:59:00",
                            "timezoneId": 4
                        }   
                        ...
                        console.log(insertion_copy.headers.location);

                        if (insertion_copy.headers.location) {
                            console.log('insertion_copy.headers.location : ',insertion_copy.headers.location)
                           
                            var url_location = Utilities.ensureHttps(insertion_copy.headers.location);
                            console.log('insertion_copy.headers.location update : ',url_location);
