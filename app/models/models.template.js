...
const Templates = sequelize.define('templates', {
    ...
    template_original: {type: Sequelize.TINYINT(),allowNull:true},
    ...
    version: {type: Sequelize.INTEGER(),allowNull:true},
    ...
    preview_image_url: {type: Sequelize.STRING(),allowNull:true},
